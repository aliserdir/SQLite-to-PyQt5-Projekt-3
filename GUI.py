...
# Form implementation generated from reading ui file 'TelefonDatenGUI.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnSil.setText(_translate("MainWindow", "LOSCHEN"))
        self.btnGuncelle.setText(_translate("MainWindow", "UPDATE"))
        self.lblID.setText(_translate("MainWindow", "ID"))
        self.lblISIM.setText(_translate("MainWindow", "VORNAME"))
        self.lblSoyisim.setText(_translate("MainWindow", "NACHNAME"))
        self.lblSehir.setText(_translate("MainWindow", "STADT"))
        self.lblTelefon.setText(_translate("MainWindow", "TELEFON"))
        self.lblEmail.setText(_translate("MainWindow", "EMAIL"))
        self.btnListele.setText(_translate("MainWindow", "LIST"))
        self.btnKaydet.setText(_translate("MainWindow", "SPEICHERN"))
